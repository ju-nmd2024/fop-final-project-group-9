export default class BlueCharacter {
  ...
  preload() {
    ...
    this.characterFrontLF = loadImage(
      "./blue character/bluecharacter-front-leftleg.png"
    );
    this.characterFrontRF = loadImage(
      "./blue character/bluecharacter-front-rightleg.png"
    );
    this.characterBack = loadImage("./blue character/bluecharacter-back.png");
    this.characterBackLF = loadImage(
      "./blue character/bluecharacter-back-leftleg.png"
    );
    this.characterBackRF = loadImage(
      "./blue character/bluecharacter-back-rightleg.png"
    );
    this.characterRightSideLF = loadImage(
      "./blue character/bluecharacter-rightside-leftleg-35.png"
    );
    this.characterRightSideRF = loadImage(
      "./blue character/bluecharacter-rightside-rightleg.png"
    );
    this.characterLeftSideLF = loadImage(
      "./blue character/bluecharacter-leftleg.png"
    );
    this.characterLeftSideRF = loadImage(
      "./blue character/bluecharacter-leftside-rightleg.png"
    );
  }
